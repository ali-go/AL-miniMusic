...
__DEFINE__(1649148762760, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1649148762761,"./event-store":1649148762762}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1649148762761, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1649148762762, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1649148762761,"./utils":1649148762763}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1649148762763, function(require, module, exports) {
...
return __REQUIRE__(1649148762760);
})()
